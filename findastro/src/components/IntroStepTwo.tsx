...
const getCardContent = (name: string) => [
  {
    title: (
      <>
        Hello {name}, <br />
...
const IntroStepTwo: React.FC<IntroStepTwoProps> = ({
  name = "User",
  onBack,
  onConfirm,
  activeDot = 0,
  ...
  return (
    <Box>
      ...
      <Box sx={{ width: "100%", px: 3, py: 4 }}>
        ...
        >
          <Typography sx={{ fontSize: '.9rem', cursor: "pointer" }} onClick={onBack}>
            &lt; Back
          </Typography>
